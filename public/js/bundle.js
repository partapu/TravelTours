          ...
          case 3:
            ...
            if (res.data.status === 'success') {
              ...
              window.setTimeout(function () {
                ...
                (0, _alert.showAlert)('success', 'You are logged out successfully');
              }, 3000); // location.reload(true);
...
var displayMap = function displayMap(locations) {
  mapboxgl.accessToken = 'pk.eyJ1IjoicHJlZXRoYW1wYXJ0YXB1IiwiYSI6ImNrdnhhZXhnYjAzZTIydm5vOG9zdzZyaW4ifQ.oKj2jJKWFI6VLmtBFQPXlQ';
        ...
        switch (_context.prev = _context.next) {
          ...
          case 3:
            ...
            if (res.data.status === 'success') {
              window.setTimeout(function () {
                location.reload(true);
                (0, _alert.showAlert)('success', 'Data updated successfuly!');
              }, 1500);
            }
        ...
        switch (_context2.prev = _context2.next) {
          ...
          case 5:
            ...
            if (res.data.status === 'Success') {
              window.setTimeout(function () {
                location.reload(true);
                (0, _alert.showAlert)('success', 'Password Changed Sucessfuly!');
              }, 1500);
            }
        ...
        switch (_context.prev = _context.next) {
          ...
          case 3:
            ...
            if (res.data.status === 'Success') {
              window.setTimeout(function () {
                location.assign('/');
                (0, _alert.showAlert)('success', 'Account is created successfuly');
              }, 1500);
            }
...
var stripe = Stripe('pk_test_51JyvVeSElnEHZ9ucBHxzRwUAn2utnywA97e4xChRH6KYW659I8ZCPBcFtxHuji892qL9pjfEcq5pfVRTHwcZXYzG00UVM5QQ3L');
...
var saveSettings = document.querySelector('.btn--small');
var passwordChange = document.querySelector('.btn--password');
var signupForm = document.querySelector('.form--Signup');
var tourBookBtn = document.getElementById('book-tour');
var locations, email, password;
...
if (saveSettings) {
  saveSettings.addEventListener('click', /*#__PURE__*/function () {
        ...
        while (1) {
          switch (_context.prev = _context.next) {
            case 0:
              ...
              _context.next = 8;
              return (0, _updateSettings.updateMyData)(form);
...
if (passwordChange) {
  passwordChange.addEventListener('click', /*#__PURE__*/function () {
        ...
        while (1) {
          switch (_context2.prev = _context2.next) {
            case 0:
              ...
              _context2.next = 7;
              return (0, _updateSettings.updateMyPassword)(passwordCurrent, password, passwordConfirm);
...
if (signupForm) {
  signupForm.addEventListener('submit', function (e) {
    ...
    var passwordConfirm = document.getElementById('retypepassword').value;
